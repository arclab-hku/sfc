...
protected:
 template<int U = Dim>
   ...
   add_global_bbox(Polyhedron<Dim> &Vs) {
     ...
     //*** X
     Vs.add(Plane2D(Vec2f(global_bbox_max_(0), 0), Vec2f(1, 0)));
     Vs.add(Plane2D(Vec2f(global_bbox_min_(0), 0), Vec2f(-1, 0)));
     //*** Y
     Vs.add(Plane2D(Vec2f(0, global_bbox_max_(1)), Vec2f(0, 1)));
     Vs.add(Plane2D(Vec2f(0, global_bbox_min_(1)), Vec2f(0, -1)));
   }
 ...
 template<int U = Dim>
   ...
   add_global_bbox(Polyhedron<Dim> &Vs) {
     ...
     //*** Z
     Vs.add(Plane3D(Vec3f(0, 0, global_bbox_max_(2)), Vec3f(0, 0, 1)));
     Vs.add(Plane3D(Vec3f(0, 0, global_bbox_min_(2)), Vec3f(0, 0, -1)));

     //*** X
     Vs.add(Plane3D(Vec3f(global_bbox_max_(0), 0, 0), Vec3f(1, 0, 0)));
